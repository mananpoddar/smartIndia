...
for i in range(no_of_points):
    ...
    # },
    lower_education = int(3 * rand_range(obj["lower_education"][0],obj["lower_education"][1]) * rand_range(obj["misc_credit"][0],obj["misc_credit"][1])) * 10  
    higher_education = int(10 * rand_range(obj["higher_education"][0],obj["higher_education"][1]) * rand_range(obj["misc_credit"][0],obj["misc_credit"][1])) * 10
    area      = "middle"
    jewellery  = int(rand_range(obj['jewellery'][0], obj['jewellery'][1])) * 10
    car       = random.randint(obj['car'][0], obj['car'][1]) + 2
    bike      = random.randint(obj['bike'][0], obj['bike'][1]) + 2
    ...
    misc_debit = int(rand_range(obj["misc_debit"][0],obj["misc_debit"][1])) * 10
...
for i in range(no_of_points):
    ...
    car       = random.randint(obj['car'][0], obj['car'][1]) + 3
    bike      = random.randint(obj['bike'][0], obj['bike'][1]) + 3
    misc_credit = int(rand_range(obj["misc_credit"][0],obj["misc_credit"][1])) / 10
    tax       = tax_bracket(misc_credit if random.random() > 0.2 else misc_credit * random.random())
    misc_debit = int(rand_range(obj["misc_debit"][0],obj["misc_debit"][1])) * 10
    new_data = [lower_education, higher_education, area, jewellery, car, bike, tax, misc_credit, misc_debit]
    with open('data_fraud.csv', 'a') as f:
...
for i in range(no_of_points):
    ...
    higher_education = int(10 * rand_range(obj["higher_education"][0],obj["higher_education"][1]) * rand_range(obj["misc_credit"][0],obj["misc_credit"][1])) * 10
    area      = "posh"
    jewellery  = int(rand_range(obj['jewellery'][0], obj['jewellery'][1])) * 3
    car       = random.randint(obj['car'][0], obj['car'][1]) + 5
    bike      = random.randint(obj['bike'][0], obj['bike'][1]) + 5
    misc_credit = int(rand_range(obj["misc_credit"][0], obj["misc_credit"][1]))
    tax       = tax_bracket(misc_credit if random.random() > 0.2 else misc_credit * random.random())
    misc_debit = int(rand_range(obj["misc_debit"][0],obj["misc_debit"][1])) * 10
    new_data = [lower_education, higher_education, area, jewellery, car, bike, tax, misc_credit, misc_debit]
